			...
			<FormContainer>
				<Form ref={formRef} onSubmit={handleSubmit}>
					<h3>A - Anamnese</h3>
						<section>
							...
							<h4>2. Dieta</h4>
								...
								<h4 size={2}>3. Sintomas gastrointestinais (persistem por mais de duas semanas</h4>
									<Checkbox size = {2}
										name='quesiton'
										label='Disfagia e/ou odinofagia'
									/>
									<Checkbox size = {2}
										name='quesiton'
										label='Náuseas'
					...
					<h3>B - Exame Físico</h3>
						<section>
							<Box>
							<h4 size={2}>6. Sintomas gastrointestinais (persistem por mais de duas semanas</h4>
									<Checkbox size = {2}
										name='quesiton'
					...
					<Button size={4}>Finalizar Avaliação</Button>
				</Form>
			</FormContainer>
		</Container>
	);
